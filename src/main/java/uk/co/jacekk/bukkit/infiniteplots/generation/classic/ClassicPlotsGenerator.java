package uk.co.jacekk.bukkit.infiniteplots.generation.classic;
...
public class ClassicPlotsGenerator extends ChunkGenerator {
	...
	public ClassicPlotsGenerator(int size, int height, byte baseId, byte surfaceId, byte pathId, byte wallLowerId, byte wallUpperId, Biome plotBiome, Biome pathBiome){
